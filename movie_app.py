...
if __name__ == '__main__':
    ...
    html_link = """
        <a href="https://github.com/rjtprasad/Movie-Recommendation-System" style="color:green;" target="_blank">Github</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://www.kaggle.com/datasets/karrrimba/movie-metadatacsv" style="color:green;" target="_blank">Dataset</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    if app_options == 'Movie based':
        ...
        if movie_select == '--Select--':
            st.write('Select a movie from dropdown list.')
        else:
